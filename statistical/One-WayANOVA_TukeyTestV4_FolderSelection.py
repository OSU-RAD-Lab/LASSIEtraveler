...
#prompts user with a folder selection window to choose a folder with csvs inside. Converts CSV to a long dataframe format
def open_folder_selection():
    ...
    try:
        ...
        #open folder and concatenate all csvs inside into one dataframe
