...
class Curves:
    ...
    def __init__(self, data_src_folder_path:str, plot_dst_folder_path:str, plot_color1:str = 'grey', plot_color2:str = 'grey'):
...
>>>>>>> Stashed changes
    ...
    def plot(self):
        ...
        plt.xlim(0, 0.05)
        plt.ylim(-4, 4) #Tried changing the bounds to (-10,20) but again no change
...
def main():
    if len(sys.argv) != 5:
        ...
        print('\tpython3 plot_curve_overlay.py data_src_folder_path plot_dst_folder_path color')
        sys.exit()

    # Create the data object
    curves = Curves(sys.argv[1], sys.argv[2], sys.argv[3], sys.argv[4])
